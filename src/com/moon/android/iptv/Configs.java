...
public class Configs {
	...
	public static String Servic_NEW = "http://api.sinopad.hk:9012/";
	...
	public static String THIS_APP_PACKAGE_NAME = "com.sinopad.launch";
	...
	public class ServerInterface{
		...
		public  final String GET_IP=SERVER_ADDRESS+"getip.php";
...
//			list.add("com.android.vending");// google play
			...
			list.add("com.moon.appstore");
			list.add("com.moon.appstore.launch");
			list.add("com.sino.appstore");//预留1
			list.add("com.sino.appshop");//预留2
			list.add("com.sino.appdown");//预留3
...
//			list.add("com.android.browser");//sys browser
			...
			list.add("com.android.inputmethod.latin");
			list.add("com.android.providers.downloads.ui");//sys download
//			list.add("com.google.android.gms");
	...
	public static String getLoginUrl(){
		return "http://192.168.100.221:9444/Box/Login/?mac="+MACUtils.getMac()+"&type=1";
	}
	private String getServer(){
		return "http://api.sinopad.hk:9011/";
	}
