...
@SuppressLint("NewApi")
public class ShopGrid extends LinearLayout implements OnKeyListener{
	...
	public ShopGrid(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		mContext = context;
		View view = LayoutInflater.from(context).inflate(R.layout.shop_view, this);
		...
		mGridApps.setNextFocusLeftId(1);
...
//		setAdapter(mListAppInfo);
		...
		AppsAdapter appsAdapter = new AppsAdapter(mContext, mListAppInfo);
...
//		List<CustomAppInfo> userInstall  = AppUtils.loadApplications(mContext,Configs.showSystemApp());
	...
	public ShopGrid(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public ShopGrid(Context context) {
		this(context,null);
	}
